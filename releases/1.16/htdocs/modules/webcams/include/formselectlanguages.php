 ...
 * @access 		public
 */
class WebcamsFormSelectLanguages extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function WebcamsFormSelectLanguages($caption, $name, $value = null, $size = 1, $multiple = false)
    {
        ...
        foreach(explode('|', $GLOBALS['xoopsModuleConfig']['languages']) as $category)
        	$this->addOption(ucfirst($category), ucfirst($category));
