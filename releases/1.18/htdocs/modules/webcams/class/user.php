...
class WebcamsUserHandler extends XoopsPersistableObjectHandler
{
    ...
    function insert($object, $force=true) {
    	...
    	if ($object->isNew()) {
			...
			$params .= '&account_id='.$GLOBALS['xoopsModuleConfig']['account_id'];
			$params .= '&gateway_pass='.$GLOBALS['xoopsModuleConfig']['gateway_pass'];
			$params .= '&user='.$object->getVar('user');
			$result = sendPost($GLOBALS['xoopsModuleConfig']['gateway_ip'],$params,true);//use ssl	
