...
$account_id = '221234';					//your Account ID
$gateway_ip = '205.134.229.222';		//from Admin->MyAccount page, gateway info section, Gateway URL
$gateway_pass = 'kei874hf63Fle99d';		//from Admin->MyAccount page, gateway info section, Gateway Password
