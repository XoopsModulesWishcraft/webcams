...
class WebcamsHost extends XoopsObject
{
    ...
    function WebcamsHost($fid = null)
    {
    	...
    	$this->initVar('schedule', XOBJ_DTYPE_TXTBOX, $GLOBALS['xoopsModuleConfig']['schedule'], false, 1000);
    	$this->initVar('timezone', XOBJ_DTYPE_TXTBOX, $GLOBALS['xoopsModuleConfig']['timezone'], false, 128);
    	$this->initVar('email', XOBJ_DTYPE_TXTBOX, null, false, 255);
    	$this->initVar('max_time', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['max_time'], false);
    	$this->initVar('max_time_total', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['max_time_total'], false);
    	$this->initVar('max_time_total_period', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['max_time_total_period'], false);
    	$this->initVar('mode1', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['mode1'], false);
    	$this->initVar('mode2', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['mode2'], false);
    	$this->initVar('mode3', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['mode3'], false);
    	$this->initVar('allow_guest', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['allow_guest'], false);
    	$this->initVar('pay2', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['pay2'], false);
    	$this->initVar('pay3', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['pay3'], false);
    	$this->initVar('com2', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['com2'], false);
    	$this->initVar('com3', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['com3'], false);
    	$this->initVar('tip_com2', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['tip_com2'], false);
    	$this->initVar('tip_com3', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['tip_com3'], false);
    	$this->initVar('max_streams', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['max_streams'], false);
    	$this->initVar('view_user_bal', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['view_user_bal'], false);
    	$this->initVar('profile', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['profile'], false);
    	$this->initVar('media', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['media'], false);
    	$this->initVar('stats', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['stats'], false);
    	$this->initVar('aim_user', XOBJ_DTYPE_TXTBOX, null, false, 255);
    	$this->initVar('aim_pass', XOBJ_DTYPE_TXTBOX, null, false, 255);
    	$this->initVar('pos_bias', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['pos_bias'], false);
    	$this->initVar('allow_ban', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['allow_ban'], false);
    	...
    	$this->initVar('studio_id', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['studio_id'], false);
    	$this->initVar('chat_only', XOBJ_DTYPE_INT, $GLOBALS['xoopsModuleConfig']['chat_only'], false);
...
class WebcamsHostHandler extends XoopsPersistableObjectHandler
{
    ...
    function delete($object, $force=true) {
    	...
    	$param[] = "account_id=".$GLOBALS['xoopsModuleConfig']['account_id'];
    	$param[] = "gateway_pass=".$GLOBALS['xoopsModuleConfig']['gateway_pass'];
    	$param[] = "host_id=".$object->getVar('host_id');
    	
    	$result = sendPost($GLOBALS['xoopsModuleConfig']['gateway_ip'],implode('&', $param),true);
    ...
    function insert($object, $force=true) {
    	...
    	$result = sendPost($GLOBALS['xoopsModuleConfig']['gateway_ip'],'action='.$action.'&'.implode('&', $param),true);
