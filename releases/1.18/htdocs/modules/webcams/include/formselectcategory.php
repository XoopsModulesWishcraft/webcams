 ...
 * @access 		public
 */
class WebcamsFormSelectCategory extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function WebcamsFormSelectCategory($caption, $name, $value = null, $size = 1, $multiple = false)
    {
        ...
        foreach(explode('|', $GLOBALS['xoopsModuleConfig']['categories']) as $category)
