...
class WebcamsStudio extends XoopsObject
{
    ...
    function WebcamsStudio($fid = null)
    {
    	...
    	$this->initVar('com2', XOBJ_DTYPE_DECIMAL, $GLOBALS['xoopsModuleConfig']['com2'], false);
    	$this->initVar('com3', XOBJ_DTYPE_DECIMAL, $GLOBALS['xoopsModuleConfig']['com3'], false);
    	$this->initVar('tip2', XOBJ_DTYPE_DECIMAL, $GLOBALS['xoopsModuleConfig']['tip2'], false);
    	$this->initVar('tip3', XOBJ_DTYPE_DECIMAL, $GLOBALS['xoopsModuleConfig']['tip3'], false);
