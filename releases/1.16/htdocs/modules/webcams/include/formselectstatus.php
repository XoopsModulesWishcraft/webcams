 ...
 * @access 		public
 */
class WebcamsFormSelectStatus extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function WebcamsFormSelectStatus($caption, $name, $value = null, $size = 1, $multiple = false)
    {
        ...
        if (isset($value)) {
        	...
        	$this->setValue('waiting');
        }
        $this->addOption('approved', _mbc_mi_approved);
        $this->addOption('waiting', _mbc_mi_waiting);
        $this->addOption('closed', _mbc_mi_closed);
    }
